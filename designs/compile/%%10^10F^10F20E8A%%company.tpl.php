<?php /* Smarty version 2.6.26, created on 2022-09-12 16:30:01
    ...
    <div class="container-xxl bg-white p-0">
        ...
        <div class="container-xxl position-relative p-0">
            <nav class="navbar navbar-expand-lg navbar-light px-4 px-lg-5 py-3 py-lg-0">
                <a href="companyhome.php" class="navbar-brand p-0">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav ms-auto py-0">
                        <a href="companyhome.php" class="nav-item nav-link active">Home</a>
                      ...
                      <!--   <div class="nav-item dropdown">
                        ...
                        <a href="companyreqview.php" class="nav-item nav-link">Requirements</a>
                        <!-- <a href="companymessageview.php" class="nav-item nav-link">Message</a> -->
                    </div>
            ...
            <div class="container">
                <div class="row g-5 align-items-center">
                    ...
                    <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                        ...
                        <h2 class="mb-4">EPLAN</h2>
                        <p class="mb-4">EPLAN Experience is a concept that provides you with specific recommendations for action for process optimisation. It shows you how you can work in a functionally structured way and follow common standards. You can use this solid foundation to increase your engineering efficiency step by step.</p>
                        <div class="row g-3 mb-4">
                            <div class="col-12 d-flex">
                                ...
                                <div class="ms-4">
                                    <h6>FIELD OF PROJECT</h6>
                                    <span>EPLAN Experience’s focus is on eight fields of action. This can be a specific subject area in your company, or a process that shows the potential for optimised engineering. Everything can be implemented, but it doesn’t have to be. The concept has an open design: your tasks and assignments determine the need for action – regardless of company size, location or industry.
