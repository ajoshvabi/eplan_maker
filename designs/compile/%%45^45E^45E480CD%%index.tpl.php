<?php /* Smarty version 2.6.26, created on 2022-10-14 07:18:38
            ...
            <nav class="navbar navbar-expand-lg navbar-light px-4 px-lg-5 py-3 py-lg-0">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav ms-auto py-0">
                     ...
                     <!--     <img class="img-fluid animated zoomIn" src="user/img/profile.png" alt=""> -->

                        <div class="nav-item dropdown">
                            <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">Registration</a>
                            <div class="dropdown-menu m-0">
                                <a href="companyreg.php" class="dropdown-item">Company</a>
                                <a href="customer_reg.php" class="dropdown-item">Customer</a>
