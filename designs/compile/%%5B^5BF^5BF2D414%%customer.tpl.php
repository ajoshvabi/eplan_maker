<?php /* Smarty version 2.6.26, created on 2022-10-14 07:19:36
       ...
       <!--  <div id="spinner" class="show bg-white position-fixed translate-middle w-100 vh-100 top-50 start-50 d-flex align-items-center justify-content-center">
        ...
        <div class="container-xxl position-relative p-0">
            <nav class="navbar navbar-expand-lg navbar-light px-4 px-lg-5 py-3 py-lg-0">
                <a href="customerhome.php" class="navbar-brand p-0">
                    <h1 class="m-0">E-PLAN</h1>
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav ms-auto py-0">
                        ...
                        <!-- <a href="complaintview.php" class="nav-item nav-link">Complaintview</a> -->
                        <a href="customerprofile.php" class="nav-item nav-link">Profile</a>

                        <a href="viewreq.php" class="nav-item nav-link">Requirements</a>

                        <div class="nav-item dropdown">
                            <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">Compalints</a>
                            <div class="dropdown-menu m-0">
                                <a href="complaint.php" class="dropdown-item">Complaints</a>
                                <a href="complaintview.php" class="dropdown-item">Complaints View</a>
                               <!--  <a href="team.html" class="dropdown-item">Our Team</a>
                                <a href="testimonial.html" class="dropdown-item">Testimonial</a>
                                <a href="404.html" class="dropdown-item">404 Page</a> -->
                            </div>
                        </div>
                         <!-- <a href="commsgreplyview.php" class="nav-item nav-link">Message</a> -->
                ...
                <div class="container">
                    <div class="row g-5 align-items-center">
                        <div class="col-lg-6 text-center text-lg-start">
                            <h1 class="text-white mb-4 animated zoomIn">Every project is a reflection of our client's personality </h1>
                            <p class="text-white pb-3 animated zoomIn">It is not the beauty of a building you should look at; its the construction of the foundation that will stand the rest of the time...</p>
                           <!--  <a href="" class="btn btn-outline-light rounded-pill border-2 py-3 px-5 animated slideInRight">Learn More</a> -->
                        </div>
                        <div class="col-lg-6 text-center text-lg-start">
                            <img class="img-fluid animated zoomIn" src="user/img/lo.png" alt="">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                <div class="row g-5 align-items-center">
                    <div class="col-lg-6 wow zoomIn" data-wow-delay="0.1s">
                        <img class="img-fluid" src="user/img/img2.png">
                    </div>
                    <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="d-inline-block border rounded-pill text-primary px-4 mb-3">About Us</div>
                        <h2 class="mb-4">E-PLAN</h2>
                        <p class="mb-4">This application acts as an online portal for building works that provide design that you need...</p>
                        <div class="row g-3 mb-4">
                            <div class="col-12 d-flex">
                                ...
                                <div class="ms-4">
                                    <h6>Business</h6>
                                    <span>This is an online portal for architecture designs</span>
                                </div>
                            </div>
                            <div class="col-12 d-flex">
                                <div class="flex-shrink-0 btn-lg-square rounded-circle bg-primary">
                                ...
                                <div class="ms-4">
                                    <h6>Services</h6>
                                    <span>Unique Designs<br>
                                    Inovative Ideas</span>
                                </div>
                            </div>
                        </div>
            ...
            <div class="container px-lg-5">
                <div class="row align-items-center" style="height: 250px;">
                    ...
                    <div class="col-md-6 text-center mb-n5 d-none d-md-block">
                        <img class="img-fluid mt-5" style="max-height: 250px;" src="user/img/newsletter.png">
                    </div>
                </div>
            </div>
        </div>
        ...
        <!-- <div class="container-xxl bg-primary my-6 py-5 wow fadeInUp" data-wow-delay="0.1s">
            <div class="container">
                <div class="owl-carousel client-carousel">
                    <a href="#"><img class="img-fluid" src="user/img/one.jpg" alt=""></a>
                    <a href="#"><img class="img-fluid" src="user/img/logo-2.png" alt=""></a>
                    <a href="#"><img class="img-fluid" src="user/img/logo-3.png" alt=""></a>
                    <a href="#"><img class="img-fluid" src="user/img/one.jpg" alt=""></a>
                    <a href="#"><img class="img-fluid" src="user/img/logo-5.png" alt=""></a>
                    <a href="#"><img class="img-fluid" src="user/img/logo-6.png" alt=""></a>
                    <a href="#"><img class="img-fluid" src="user/img/logo-7.png" alt=""></a>
                    <a href="#"><img class="img-fluid" src="user/img/logo-8.png" alt=""></a>
                </div>
            </div>
        </div> -->
        <!-- Client End -->
            ...
            <div class="container">
                ...
                <div class="owl-carousel testimonial-carousel wow fadeInUp" data-wow-delay="0.1s">
                    <div class="testimonial-item rounded p-4">
                        ...
                        <p>Its helpful!It helps me to select the wanted requirements I needed</p>
                        <div class="d-flex align-items-center">
                            <img class="img-fluid flex-shrink-0 rounded-circle" src="user/img/testimonial-1.jpg">
                            <div class="ps-3">
                    ...
                    <div class="testimonial-item rounded p-4">
                        ...
                        <p></p>
                        <div class="d-flex align-items-center">
                            <img class="img-fluid flex-shrink-0 rounded-circle" src="user/img/testimonial-2.jpg">
                            <div class="ps-3">
                                <h6 class="mb-1">Client Name</h6>
                                <small>Profession</small>
                            </div>
                    ...
                    <div class="testimonial-item rounded p-4">
                        ...
                        <div class="d-flex align-items-center">
                            <img class="img-fluid flex-shrink-0 rounded-circle" src="user/img/testimonial-3.jpg">
                            <div class="ps-3">
                                <h6 class="mb-1">Client Name</h6>
                                <small>Profession</small>
                            </div>
                    ...
                    <div class="testimonial-item rounded p-4">
                        ...
                        <p>Dolor et eos labore, stet justo sed est sed. Diam sed sed dolor stet amet eirmod eos labore diam</p>
                        <div class="d-flex align-items-center">
                            <img class="img-fluid flex-shrink-0 rounded-circle" src="user/img/testimonial-4.jpg">
                            <div class="ps-3">
                                <h6 class="mb-1">Client Name</h6>
                                <small>Profession</small>
                            </div>
            ...
            <div class="container py-5">
                <div class="row g-5">
                    <div class="col-md-6 col-lg-3">
                        ...
                        <p><i class="fa fa-envelope me-3"></i>eplan@gmail.com</p>
                        <div class="d-flex pt-2">
                            ...
                            <a class="btn btn-outline-light btn-social" href="https://www.linkedin.com/signuphttps://www.linkedin.com/signup"><i class="fab fa-linkedin-in"></i></a>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-3">
