<?php /* Smarty version 2.6.26, created on 2022-10-07 18:53:02
            ...
            <div class="nk-nav-scroll">
                <ul class="metismenu" id="menu">
                  ...
                  <!--   <li class="mega-menu mega-menu-sm">
                    ...
                    <li>
                        <a class="has-arrow" href="javascript:void()" aria-expanded="false">
                            <i class="icon-envelope menu-icon"></i> <span class="nav-text">Verify</span>
                        </a>
                        <ul aria-expanded="false">
                            <li><a href="admincompanyview.php">Company</a></li>
                            <li><a href="admincustomerview.php">Customer</a></li>
                        </ul>
                    </li>
                    <li>
                        <a class="has-arrow" href="javascript:void()" aria-expanded="false">
                            <i class="icon-screen-tablet menu-icon"></i><span class="nav-text">Complaints</span>
                        </a>
                        <ul aria-expanded="false">
                            <li><a href="admincomplaintview.php">View</a></li>
                ...
                <div class="row">
                    <div class="col-lg-3 col-sm-6">
                        <div class="card gradient-1">
                            <div class="card-body">
                                <?php $_from = $this->_tpl_vars['countcom']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['c']):
?>
                                <h3 class="card-title text-white">Company Registered</h3>
                                <div class="d-inline-block">
                                    <h2 class="text-white"><?php echo $this->_tpl_vars['c']; ?>
</h2>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="card gradient-3">
                            <div class="card-body">
                             <?php $_from = $this->_tpl_vars['countcus']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['cu']):
?>
                                <h3 class="card-title text-white">Customers Registered</h3>
                                <div class="d-inline-block">
                                    <h2 class="text-white"><?php echo $this->_tpl_vars['cu']; ?>
</h2>
                                    <!-- <p class="text-white mb-0">Jan - March 2019</p> -->
                                </div>
                                <span class="float-right display-5 opacity-5"><i class="fa fa-users"></i></span>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="card gradient-2">
                            <div class="card-body">
                                <?php $_from = $this->_tpl_vars['countcomp']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['coc']):
?>
                                <h3 class="card-title text-white">Complaints</h3>
                                <div class="d-inline-block">
                                    <h2 class="text-white"><?php echo $this->_tpl_vars['coc']; ?>
</h2>
...
<!-- 
    ...
    ***********************************-->
    ...
    <!-- Circle progress -->
    <script src="admin/admin/plugins/circle-progress/circle-progress.min.js"></script>
    <!-- Datamap -->
