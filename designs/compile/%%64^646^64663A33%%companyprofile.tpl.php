<?php /* Smarty version 2.6.26, created on 2022-09-12 16:40:01
         compiled from companyprofile.tpl */ ?>
<!-- <html>
<head> 
...
?>		 
		<h2><u> EPLAN </u></h2>
			...
			<tr>
				<td>Companyname</td>
				<td><input type="text" name="companyname" value="<?php echo $this->_tpl_vars['b']['company_name']; ?>
" class="form-control"></td>
		   </tr>
			<tr>
				<td>Address</td>
				<td><textarea name="address" class="form-control"><?php echo $this->_tpl_vars['b']['address']; ?>
</textarea></td>
			</tr>
			<tr>
				<td>Pincode</td>
				<td><input type="text" name="pincode" value="<?php echo $this->_tpl_vars['b']['pincode']; ?>
"  class="form-control"></td>
			</tr>
			<tr>
				<td>District</td>
			...
			<tr>
				<td>City</td>
				<td><input type="text" name="city" value="<?php echo $this->_tpl_vars['b']['city']; ?>
"  class="form-control"></td>
			</tr>
			<tr>
				<td>Contact No</td>
				<td><input type="text" name="contactno" value="<?php echo $this->_tpl_vars['b']['contactno']; ?>
" class="form-control"></td>
			</tr>
			<tr>
				<td>Email</td><td> <input type="email" name ="email" value="<?php echo $this->_tpl_vars['b']['email']; ?>
" class="form-control"></td>
			</tr>
...
?>	
                                        <h3 class="mb-0"><?php echo $this->_tpl_vars['a']['company_name']; ?>
</h3>
...
" class="form-control"></td>
			...
			<tr>
				<h6><td>Email</td></h6><td>< <input type="email" name ="email" value="<?php echo $this->_tpl_vars['b']['email']; ?>
" class="form-control"></td>
			</tr>
		   		   <br>
