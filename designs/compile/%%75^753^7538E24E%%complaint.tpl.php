<?php /* Smarty version 2.6.26, created on 2022-09-12 16:56:16
...
<form method="POST" action="">
			...
			<tr>
			<td>Complaint</td>
			<td><textarea name="complaint" class="form-control mt-3"></textarea></td>
			</tr>
		<tr>  
        ...
        <div class="container-xxl py-6">
            <div class="container">
                <div class="mx-auto text-center wow fadeInUp" data-wow-delay="0.1s" style="max-width: 600px;">
                    <div class="d-inline-block border rounded-pill text-primary px-4 mb-3">Complaint</div>
                    ...
                    <div class="col-lg-7 wow fadeInUp" data-wow-delay="0.3s">
                        ...
                        <form method="POST" action="">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-12">
                                    <div class="form-floating">
                                        <textarea name="complaint" class="form-control" placeholder="Leave a message here" style="height: 150px"></textarea>
