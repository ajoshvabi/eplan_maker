<?php /* Smarty version 2.6.26, created on 2022-08-22 10:16:18
         compiled from commsgreply.tpl */ ?>
<!-- <!DOCTYPE html>
<html>
<head>
	<title></title>
...
<form method="POST" action="">
			...
			<td>Reply</td>
				<tr><textarea name="creply" class="form-control mt-3"></textarea></tr>
        ...
        <!--   <li class="clearfix">
          ...
          <li>
            <div class="message-data">
               <span class="message-data-time"><?php echo $this->_tpl_vars['h']['ctime']; ?>
</span>
               <span class="message-data-name" >Olia</span> <i class="fa fa-circle me"></i>
            </div>
            <div class="message my-message">
             <?php echo $this->_tpl_vars['h']['message']; ?>
...
?>
             <?php echo $this->_tpl_vars['b']['message']; ?>
...
?>
  ...
  <li class="clearfix">
    <div class="message-data align-right">
      <span class="message-data-time" ><?php echo $this->_tpl_vars['b']['ctime']; ?>
, Today</span> &nbsp; &nbsp;
      <span class="message-data-name" >Olia</span> <i class="fa fa-circle me"></i>
    </div>
    <div class="message other-message float-right">
