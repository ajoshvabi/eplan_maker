<?php /* Smarty version 2.6.26, created on 2022-09-25 20:48:40
         compiled from editmysuggestion.tpl */ ?>
<!-- <html>
<head> 
...
?>
   <form method="POST" action=" ">
    ...
    <tr>
      ...
      <td>
        <textarea name="suggestion" class="form-control mt-3"><?php echo $this->_tpl_vars['a']['suggestion']; ?>
</textarea>
      </td>
        ...
        <div class="container-xxl py-6">
            <div class="container">
                <div class="mx-auto text-center wow fadeInUp" data-wow-delay="0.1s" style="max-width: 600px;">
                    <div class="d-inline-block border rounded-pill text-primary px-4 mb-3">Edit suggestion</div>
...
?>
                                ...
                                <div class="col-12">
                                    <div class="form-floating">
                                        <textarea name="suggestion" class="form-control" placeholder="Leave a message here" style="height: 150px"><?php echo $this->_tpl_vars['d']['suggestion']; ?>
</textarea>
                                ...
                                <?php endforeach; endif; unset($_from); ?>
                                <div class="col-12">
                                    <button class="btn btn-primary w-100 py-3" type="submit">Edit suggestion</button>
                                </div>
                            </div>
                        </form>
                    </div>
