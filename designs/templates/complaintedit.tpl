...
<body>
	...
	<form method="POST" action=" ">
		...
		<tr>
			<td>complaint</td>
			<td>
				<textarea name="complaint" class="form-control mt-3">{$d.complaint}</textarea>
			</td>
		</tr>
                    ...
                    <div class="col-lg-7 wow fadeInUp" data-wow-delay="0.3s">
                        ...
                        <form method="POST" action="">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-12">
                                    <div class="form-floating">
                                        <textarea name="complaint" class="form-control" placeholder="Leave a message here" style="height: 150px">{$d.complaint}</textarea>
