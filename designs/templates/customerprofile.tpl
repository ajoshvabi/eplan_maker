...
<body>
	...
	<form method="POST" action="">
		{foreach from=$view item="a"}	
			...
			<tr>
				<td>Name</td>
				<td><input type="text" name="name" value= "{$a.name}" class="form-control mt-3"></td>
			</tr>
			<tr>
				<td>Address</td>
			...
			<tr>
				<td>Contact No</td>
				<td><input type="text" name="contactno" value="{$a.contactno}" class="form-control mt-3"></td>
			</tr>
			<tr>
				<td>District</td>
				<td>
			...
			<tr>
				<td>City</td>
				<td><input type="text" name="city" value="{$a.city}" class="form-control mt-3"></td>
			</tr>
			
			<tr>
				<td>Email</td><td> <input type="email" name ="email" value="{$a.email}" class="form-control mt-3"></td>
			</tr>
...
<div class="media align-items-center mb-5">
		...
		<!-- {foreach from=$view item="a"}	 -->
			...
			<tr>
				<h6><td>Email</td></h6><td> <input type="email" name ="email" value="{$a.email}" class="form-control mt-3"></td>
			</tr>
			<br>
...
<br>
			...
			<h4>About Me</h4>
                                ...
                                <ul class="card-profile__info">
                                    ...
                                    <li><strong class="text-dark mr-4">Email</strong> <span>{$a.email}</span></li>
                                </ul>
				{/foreach}
