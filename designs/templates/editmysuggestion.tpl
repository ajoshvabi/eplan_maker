...
<body>
   ...
   <form method="POST" action=" ">
    ...
    <tr>
      ...
      <td>
        <textarea name="suggestion" class="form-control mt-3">{$a.suggestion}</textarea>
      </td>
                          ...
                          <input type="hidden" name="hide" value="h">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-12">
                                    ...
                                    {foreach from=$viewsug item="d"}

                                <div class="col-12">
                                    <div class="form-floating">
                                        <textarea name="suggestion" class="form-control" placeholder="Leave a message here" style="height: 150px">{$d.suggestion}</textarea>
