        ...
        <div class="wrapper wrapper--w790">
            <div class="card card-5">
                <div class="card-heading">
                    <h2 class="title">Plan Requrement</h2>
                </div>
                <div class="card-body">
                    <form method="POST">
                        <input type="hidden" name="hide" value="h">
                        <div class="form-row m-b-55">
                            <div class="name">Building type </div>
                            <div class="value">
                                <div class="row row-space">
                                    
                                            <input class="input--style-5" type="text" name="buildingtype">
                        ...
                        <div class="form-row m-b-55">
                            ...
                            <div class="value">
                                <div class="row row-space">
                                            ...
                                            <input class="input--style-5" type="text" name="model">
                        ...
                        <div class="form-row m-b-55">
                            ...
                            <div class="value">
                                <div class="row row-space">
                                            ...
                                            <input class="input--style-5" type="text" name="noofrooms">
                        ...
                        <div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    ...
                                    <textarea class="input--style-5" name="otherrequirements"></textarea>
                                </div>
                            </div>
                        </div>
